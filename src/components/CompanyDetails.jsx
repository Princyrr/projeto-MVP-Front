        ...
        <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <InfoCard
                  ...
                  fullWidth
                />
                <InfoCard icon={Hash} title="Número" value={company.numero} />
                <InfoCard
                  icon={FileText}
                  title="Complemento"
                  value={company.complemento}
                />
                <InfoCard icon={MapPin} title="Bairro" value={company.bairro} />
                <InfoCard
                  icon={MapPin}
                  title="Município"
          ...
          {(company.email || company.telefone) && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <InfoCard icon={Mail} title="E-mail" value={company.email} />
                <InfoCard
                  icon={Phone}
                  title="Telefone"
          ...
          />
          <Contacts cnpj={company.cnpj} isRegistered={isRegistered} />

...
export default function Sidebar({ currentPage, onNavigate, user, onLogout }) {
  ...
  const handleNavigate = (id) => {
    onNavigate(id);
    setOpen(false); // fecha no mobile ao navegar
  };

  return (
    <>
      {/* TOP BAR MOBILE */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-3 bg-slate-950 border-b border-slate-800">
      ...
      <div
        className={`
          ...
          flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950
          text-white border-r border-slate-800 shadow-xl
      ...
      >
        ...
        {/* LOGO */}
        <div className="p-6 flex flex-col items-center border-b border-slate-800/60 mt-10 md:mt-0">
